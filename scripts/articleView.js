(function(module) {
  ...
  articleView.initIndexPage = function() {
    ...
    articleView.initStatsPage();
    articleView.initNewArticlePage();
  };

  articleView.initStatsPage = function() {
    ...
    $('#blog-stats .articles').text(util.commas(Article.all.length));
    $('#blog-stats .words').text(util.commas(Article.numWordsAll()));
  };
